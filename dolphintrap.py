...
def choose_trap_mode():
    ...
    print("Choose a mode:")
    print()
    print(Fore.GREEN + Style.BRIGHT + "1. Basic Mode")
    print()
    print(Fore.MAGENTA + Style.BRIGHT + "2. Pretty Mode")
    print()
    print(Fore.YELLOW+ Style.BRIGHT + "3. Advanced Mode")
    print()
    print(Fore.CYAN + Style.BRIGHT + "4. Art Mode")
    print()
