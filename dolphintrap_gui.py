...
message_label = customtkinter.CTkLabel(root, text="In progress, if you are submitting and it still says this, something is wrong", fg_color=None)
...
def create_html():
    ...
    # Labels for messages (success and error)
    message_label = customtkinter.CTkLabel(root, text="Successfully created your HTML file", fg_color=None)
    message_label.grid(row=14, column=0, padx=20, pady=10, sticky="ew")
...
#Title of the APP
app_title = customtkinter.CTkLabel(root, font=('Courier New',40, 'bold'), text="DolpinTrapGUI is under construction", wraplength=1200)
app_title.grid(row=0, column=0, padx=10, pady=10, sticky="ew")

# Entry 1: Title Bar
gui_title = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="What text do you want in the title bar? (Typically the company name): ")
gui_title.grid(row=3, column=0, padx=20, pady=20, sticky="ew")

# Entry 2: Company Logo
gui_company_logo = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Provide a .SVG file of the company logo. (Path to .SVG file no quotes or whitespace): ")
gui_company_logo.grid(row=4, column=0, padx=20, pady=20, sticky="ew")

#Entry 3 Company Name
gui_company_name = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="What is the name of the company?")
gui_company_name.grid(row=5, column=0, padx=20, pady=20, sticky="ew")

#Entry 4 Welcome Text
gui_welcome_text = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text='Enter the text you want to display. ("Enjoy our free WiFi!"): ')
gui_welcome_text.grid(row=6, column=0, padx=20, pady=20, sticky="ew")

#Entry 5 Connect Button Text
gui_connect_button_text = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text='Enter the text you want to display on the connect button. ("Connect"): ')
gui_connect_button_text.grid(row=7, column=0, padx=20, pady=20, sticky="ew")

#Entry 6 Company Address
gui_company_address = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Enter the address of the company: ")
gui_company_address.grid(row=8, column=0, padx=20, pady=20, sticky="ew")

#Entry 7 Company Phone Number
gui_company_phone = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Enter the phone number of the company: ")
gui_company_phone.grid(row=9, column=0, padx=20, pady=20, sticky="ew")

#Entry 8 Connect Button Color
connect_button_color = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Enter the color of the connect button: (HEX)")
connect_button_color.grid(row=10, column=0, padx=20, pady=20, sticky="ew")

#Entry 9 Connect Button Hover Color
connect_button_hover_color = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Enter the hover color of the connect button: (HEX)")
connect_button_hover_color.grid(row=11, column=0, padx=20, pady=20, sticky="ew")

#Entry 10 Output File Name
output_file_name = customtkinter.CTkEntry(root, font=('Courier New',20), width=50, placeholder_text="Enter the name of the output file: ")
output_file_name.grid(row=12, column=0, padx=20, pady=20, sticky="ew")

# Single button to submit all entry data
submit_all_button = customtkinter.CTkButton(root, font=('Courier New',20), text="Submit All", fg_color="#e88004", text_color='black', command=submit_all_data)
